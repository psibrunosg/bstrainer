  ...
  return (
    <div className="space-y-6">
      <div className="animate-rise">
        <h1 className="font-display text-3xl lg:text-4xl">Ajustes</h1>
        <p className="mt-1 text-muted-foreground">Perfil, conta e preferências.</p>
      </div>

      <section className="card-surface flex items-center gap-4 rounded-2xl p-5 animate-rise" style={{ animationDelay: '60ms' }}>
      ...
      <div className="card-surface divide-y divide-line overflow-hidden rounded-2xl animate-rise" style={{ animationDelay: '120ms' }}>
      ...
      <button className="flex w-full items-center justify-center gap-2 rounded-2xl border border-destructive/40 py-3.5 text-sm font-semibold text-destructive transition-colors hover:bg-destructive/10 animate-rise" style={{ animationDelay: '240ms' }}>
